...
Install (users): `npx -y github:buildplate/buildplate setup` then `npx -y github:buildplate/buildplate start`. MCP command is `npx -y github:buildplate/buildplate`. Data: `~/buildplate`.
